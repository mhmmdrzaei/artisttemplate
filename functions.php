...
function hackeryou_styles(){
	...
	wp_enqueue_style('googlefonts', 'https://fonts.googleapis.com/css?family=Montserrat:700|EB+Garamond');
}
...
//hackerYou_get_thumbnail_url: return current current post thumbnail url 
